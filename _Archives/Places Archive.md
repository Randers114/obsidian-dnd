...
# Description
- Visual: A well-stocked shop dealing in adventuring goods *(exact appearance not described)*
...
# Notes
- Located in [[Westruun]]
- The group visited the shop to browse supplies
...
```yaml
type: place
placeType: mansion / auction house
region:
controlledBy:
tags:
  - place
...
# Description
- Visual: Large mansion in a wealthy district
- Atmosphere: Exclusive and secretive *(inferred)*
- Notable features:
  - Hosts illegal auctions
  - Requires invitation or connections for entry
...
# Notes
- Location of the [[Suntree Root]]
- Known for illegal trade of rare and restricted goods
- Accessible only through connections or invitation
...
# Description
- Visual:
  - Monastery complex near [[Sephrah]]
  - Structured training environment
- Atmosphere:
  - Disciplined and focused
  - Recently more active following earlier events
- Notable features:
  - Training grounds for students
  - Offices for leadership
...
- Former students include:
  - [[Severin]]
  - [[Gruuk Stonejaw]]
- Connected to the amulet found near the portal ruins
- Previously affected by nearby instability and attacks *(context from earlier sessions)*
...
# Description
- Visual:
  - Waterfront structures and warehouses
  - Guarded and partially restricted areas
- Atmosphere:
  - Busy but tense *(inferred)*
  - Likely tied to trade and smuggling *(inferred)*
- Notable features:
  - Water Watch controlled areas
  - Restricted warehouse access

---

# Important NPCs
- (Customs Captain – unnamed)
- (Water Watch guards)
...
# Notes
- Location of the ledger requested by the singer
- Public access is restricted in certain areas
- Guards control entry to key locations
- Bribes can be used to gain access
- Likely involved in movement of illegal goods *(inferred)*
...
- Visual:
  ...
  - Uneven streets with patched holes
- Atmosphere:
  - High humidity with a constant smell of rot from the surrounding swamp
  - Feels unstable and neglected
- Notable features:
  - Clear divide between poorer districts and wealthy areas with large mansions
  - Visible signs of crime and lack of strong authority
...
# Notes
- Identified as location of Suntree root
- Thieves are known to possess the root
- First destination chosen by the group
- The city appears highly corrupt, allowing illegal trade to operate openly
- [[Greydawn Hall]] is a known location for illicit auctions
- Strong presence of criminal activity
- Social inequality is clearly visible between districts
- Likely hub for black market trade *(inferred)*
...
- Atmosphere: (Unknown)
- Notable features:
  - Associated with vampire activity
...
# Notes
- Mentioned by [[Lorvein Drenner]] as a location where vampires may signal activity
- Located to the north *(relative to current position – inferred)*
- Potential area of increased vampire presence or coordination *(uncertain)*
- Contains the [[Suntree]], a heavily guarded sacred landmark
- Authorities may allow access to Residium through official approval
- Current local issues include a missing child and a stolen Residium shipment
- The city has a prestigious special rifle corps  
- The rifle corps trains under [[Lord Darolo]]  
- Only about 30 members serve in the corps  
